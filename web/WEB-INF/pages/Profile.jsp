        ...
        <div class="profile">
            <form action="/updateUser" method="post">
                ...
                <div>
                    ...
                    <input id = "login" name="login" type="text" pattern="^[a-zA-Z][a-zA-Z0-9-]{1,20}$" maxlength="20" value="${user.login} "/>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input id = "country" type="text" name="country" pattern="^[а-яА-ЯёЁa-zA-Z]+$" value="${user.address.country}"/>
                </div>
                <div>
                    <label for="city"><fmt:message key="text.user_city" bundle="${bundle}"/> </label>
                    <input id = "city" type="text" name="city" pattern="^[а-яА-ЯёЁa-zA-Z]+$" value="${user.address.city}"/>
                </div>
                <div>
                    <label for="street"><fmt:message key="text.street" bundle="${bundle}"/> </label>
                    <input id = "street" type="text" name="street" pattern="^[а-яА-ЯёЁa-zA-Z]+$" value="${user.address.street}"/>
                </div>
                <div>
